...
// Note: Since we only expect these functions to be called on a small handful of types (double, complex, etc), they are
// explicitly instantiated in the .cpp file.

// Compute the eigenvector corresponding to the smallest eigenvalue for a symmetric positive definite matrix using
// inverse power iterations
template <typename T>
Eigen::Matrix<T, Eigen::Dynamic, 1>
smallestEigenvectorPositiveDefinite(Eigen::SparseMatrix<T, Eigen::ColMajor> &energyMatrix,
