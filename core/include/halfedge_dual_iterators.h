...
// TODO "Interior" iterators have not yet been implemented; some careful thought about what this means for dual meshes is needed.

// Iterate around all incoming halfedges (both on the interior and the boundary of the domain)
class DualVertexIncomingDualHalfedgeIterator {
  
    public:
        DualVertexIncomingDualHalfedgeIterator(DualHalfedgePtr startingDualEdge, bool justStarted);
...
// Iterate around all outgoing halfedges (both on the interior and the boundary of the domain)
class DualVertexOutgoingDualHalfedgeIterator {
  
    public:
        DualVertexOutgoingDualHalfedgeIterator(DualHalfedgePtr startingDualEdge, bool justStarted);
...
class DualVertexAdjacentDualVertexIterator {
    ...
    public:
        DualVertexAdjacentDualVertexIterator(DualHalfedgePtr startingDualEdge, bool justStarted);
...
class DualVertexAdjacentDualFaceIterator {
    ...
    public:
        DualVertexAdjacentDualFaceIterator(DualHalfedgePtr startingDualEdge, bool justStarted);
...
class DualVertexAdjacentDualEdgeIterator {
    ...
    public:
        DualVertexAdjacentDualEdgeIterator(DualHalfedgePtr startingDualEdge, bool justStarted);
...
class DualFaceAdjacentDualHalfedgeIterator {
    ...
    public:
        DualFaceAdjacentDualHalfedgeIterator(DualHalfedgePtr startingDualEdge, bool justStarted);
...
class DualFaceAdjacentDualVertexIterator {
    ...
    public:
        DualFaceAdjacentDualVertexIterator(DualHalfedgePtr startingDualEdge, bool justStarted);
...
class DualFaceAdjacentDualEdgeIterator {
    ...
    public:
        DualFaceAdjacentDualEdgeIterator(DualHalfedgePtr startingDualEdge, bool justStarted);
...
class DualFaceAdjacentDualFaceIterator {
    ...
    public:
        DualFaceAdjacentDualFaceIterator(DualHalfedgePtr startingDualEdge, bool justStarted);
