...
#ifndef NDEBUG
    assert(v->parentMesh == dualMesh && "Attempted to access data with member from wrong dualMesh");
#endif
...
#ifndef NDEBUG
    assert(v->parentMesh == dualMesh && "Attempted access data with member from wrong dualMesh");
#endif
    unsigned int i = v - dualMesh->vertex(0);
    return data[i];
}
...
#ifndef NDEBUG
    assert(e->parentMesh == dualMesh && "Attempted access data with member from wrong dualMesh");
#endif
...
#ifndef NDEBUG
    assert(f->parentMesh == dualMesh->mesh && "Attempted access data with member from wrong dualMesh");
#endif
...
#ifndef NDEBUG
    assert(he->parentMesh == dualMesh && "Attempted access data with member from wrong dualMesh");
#endif
