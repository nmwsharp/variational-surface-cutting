...
inline VertexIncomingHalfedgeIterator VertexIncomingHalfedgeSet::begin() { return VertexIncomingHalfedgeIterator(firstHe, true); }
inline VertexIncomingHalfedgeIterator VertexIncomingHalfedgeSet::end() { return VertexIncomingHalfedgeIterator(firstHe, false); }
...
inline VertexIncomingInteriorHalfedgeIterator VertexIncomingInteriorHalfedgeSet::begin() { return VertexIncomingInteriorHalfedgeIterator(firstHe, true); }
inline VertexIncomingInteriorHalfedgeIterator VertexIncomingInteriorHalfedgeSet::end() { return VertexIncomingInteriorHalfedgeIterator(firstHe, false); }
...
inline bool VertexIncomingInteriorHalfedgeIterator::operator==(const VertexIncomingInteriorHalfedgeIterator& other) const {
    return currHe == other.currHe && justStarted == other.justStarted;
}
inline bool VertexIncomingInteriorHalfedgeIterator::operator!=(const VertexIncomingInteriorHalfedgeIterator& other) const {
    return !(*this == other);
...
inline VertexOutgoingHalfedgeIterator VertexOutgoingHalfedgeSet::begin() { return VertexOutgoingHalfedgeIterator(firstHe, true); }
inline VertexOutgoingHalfedgeIterator VertexOutgoingHalfedgeSet::end() { return VertexOutgoingHalfedgeIterator(firstHe, false); }
...
// Note: This is currently commented out because 
//   A) It's currently broken, and can infinite-loop for a boundary vertex
inline VertexOutgoingInteriorHalfedgeIterator VertexOutgoingInteriorHalfedgeSet::begin() { return VertexOutgoingInteriorHalfedgeIterator(firstHe, true); }
inline VertexOutgoingInteriorHalfedgeIterator VertexOutgoingInteriorHalfedgeSet::end() { return VertexOutgoingInteriorHalfedgeIterator(firstHe, false); }
...
inline bool VertexOutgoingInteriorHalfedgeIterator::operator==(const VertexOutgoingInteriorHalfedgeIterator& other) const {
    return currHe == other.currHe && justStarted == other.justStarted;
}
inline bool VertexOutgoingInteriorHalfedgeIterator::operator!=(const VertexOutgoingInteriorHalfedgeIterator& other) const {
    return !(*this == other);
...
// === Adjacent vertices 
inline VertexAdjacentVertexIterator VertexAdjacentVertexSet::begin() { return VertexAdjacentVertexIterator(firstHe, true); }
inline VertexAdjacentVertexIterator VertexAdjacentVertexSet::end() { return VertexAdjacentVertexIterator(firstHe, false); }
...
// === Adjacent corners
inline VertexAdjacentCornerIterator VertexAdjacentCornerSet::begin() { return VertexAdjacentCornerIterator(firstHe, true); }
inline VertexAdjacentCornerIterator VertexAdjacentCornerSet::end() { return VertexAdjacentCornerIterator(firstHe, false); }
...
// === Adjacent halfedges
inline FaceAdjacentHalfedgeIterator FaceAdjacentHalfedgeSet::begin() { return FaceAdjacentHalfedgeIterator(firstHe, true); }
inline FaceAdjacentHalfedgeIterator FaceAdjacentHalfedgeSet::end() { return FaceAdjacentHalfedgeIterator(firstHe, false); }
